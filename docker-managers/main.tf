...
# ---------------------------------------------------------------------------------------------------------------------
# CREATE AN AUTO SCALING GROUP (ASG) TO RUN DOCKER
# ---------------------------------------------------------------------------------------------------------------------
...
resource "aws_autoscaling_group" "autoscaling_group" {
  ...
  tags = ["${concat(
    list(
      map("key", var.cluster_tag_key, "value", var.swarm_name, "propagate_at_launch", true)
    ),
...
resource "aws_launch_configuration" "launch_configuration" {
  name_prefix   = "${var.swarm_name}-manager"
  image_id      = "${var.ami_id}"
